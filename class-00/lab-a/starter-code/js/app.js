...
function displayPics(){
  ...
  // rando lives inside the displayPics function so it can no longer be accessed outside of it because it was declared with let
  console.log(viewed);
...
function showList() {
  for(let i = 0; i < allProducts.length; i++) {
    ...
    liEl.textContent = `${allProducts[i].name} ${allProducts[i].votes} votes in ${allProducts[i].views} views`;
